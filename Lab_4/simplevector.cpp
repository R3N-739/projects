 ...
 * Author: Dr. Mark E. Lehr & Renzo Di Cristofaro
...
{
   //Student Code Here
   //create new array in memory size+1
...
T SimpleVector<T>::popFrnt()
{
   ...
   //Create new array in memory size-1
   T* temp = new T[arraySize-1];
   //save return value from front of old array
   T ret=aptr[0];
   //fill array with old values starting at index 1
...
T SimpleVector<T>::popBack()
{
   ...
   //Create new array in memory size-1
   T* temp = new T[arraySize-1];
   //save return value from back of old array
   T ret=aptr[arraySize-1];
   //fill array with old values starting at index 0
   //ending copying before final value
